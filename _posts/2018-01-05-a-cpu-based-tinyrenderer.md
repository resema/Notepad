...
In theory we need to compute the **solid angle** for each point of the z-buffer. The solid angle can be **approximated** by a $$\sum{\frac{90-\text{max_elevation_angle}}{\text{n-directions}}}$$. 