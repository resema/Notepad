...
#### Sampler State
Sampler State, [Link](https://msdn.microsoft.com/en-us/library/ff604998.aspx) determines how texture data is sampled using texture addressing modes, filtering and level of detail.
