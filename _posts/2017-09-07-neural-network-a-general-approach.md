...
$$ for\, each\, i: $$<br>
$$\,\,\theta_{approx}[i] = 1/2*\epsilon * ( J(\theta_1,\, \theta_2,\ ...,\, \theta_i + \epsilon) - J(\theta_1, \theata_2, ..., \theta_i - \epsilon) ); $$<br> <br>
$$CheckEuclideanDist((d\theta_{approx} - d\theta) / (d\theta_{approx} + d\theta))$$ <br>
